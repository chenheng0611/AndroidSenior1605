...
import com.qianfeng.day10_alipay.pay.H5PayDemoActivity;
import com.qianfeng.day10_alipay.pay.PayResult;
import com.qianfeng.day10_alipay.pay.SignUtils;
...
public class CartActivity extends AppCompatActivity {
    ...
    private void initViews() {
        mCartLv = (ListView)findViewById(R.id.cart_list_lv);
        mCartLv.setAdapter(new CartAdapter());
    }

    private void initData() {
        //查询购物车的数据
        mProductDao = DBUtils.getProductDao(this);
        mProducts = mProductDao.queryBuilder().list();
    }
    ...
    class CartAdapter extends BaseAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(view == null){
                view = LayoutInflater.from(CartActivity.this).inflate(R.layout.cart_item,parent,false);
            ...
            holder.mNumEt.setText(""+product.getProductNum());
            holder.mAddNumBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if(product.getProductNum() == 5){
                        Toast.makeText(CartActivity.this, "同样的商品数量不能超过5", Toast.LENGTH_SHORT).show();
                    }else{
            ...
            holder.mSubNumBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if(product.getProductNum() == 1){
                        Toast.makeText(CartActivity.this, "同样的商品数量不能小于1", Toast.LENGTH_SHORT).show();
                    }else{
                        product.setProductNum(product.getProductNum()-1);
                        notifyDataSetChanged();
                    }
        ...
        class ViewHolder{
            ...
            public ViewHolder(View view){
                mProductNameTv = (TextView)view.findViewById(R.id.cart_name_tv);
                mAddNumBtn = (Button)view.findViewById(R.id.cart_add_num_btn);
                mSubNumBtn = (Button)view.findViewById(R.id.cart_sub_num_btn);
                mNumEt = (EditText)view.findViewById(R.id.cart_num_et);
                view.setTag(this);
            }
    ...
    private String getCartInfo(){
        ...
        stringBuilder.append("购买商品清单:\n");
        float total = 0;
        for(Product product : mProducts){
            stringBuilder.append("商品名称:"+product.getProductName()+",价格:"+product.getProductPrice()+",数量:"+product.getProductNum()+"\n");
            total += product.getProductNum() * product.getProductPrice();
        }
        stringBuilder.append("总价:$"+total);
    ...
    protected void onDestroy() {
        super.onDestroy();
        //清空购物车
        DBUtils.getProductDao(this).deleteAll();
    }
    ...
    private void pay(){
        ...
        String orderInfo = getOrderInfo("宇宙飞船", "光速飞行,买一送一", "0.01");
    ...
    public void h5Pay(View v) {
        ...
        /**
         * url是测试的网站，在app内部打开页面是基于webview打开的，demo中的webview是H5MainActivity，
         * demo中拦截url进行支付的逻辑是在H5MainActivity中shouldOverrideUrlLoading方法实现，
         * 商户可以根据自己的需求来实现
         */
